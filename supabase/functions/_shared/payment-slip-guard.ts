...
function buildReply(category: PaymentSlipCategory, amount: number | null): string {
  if (category === "deposit_slip_received") {
    return amount !== null
      ? `รับทราบสลิปยอด ${formatAmount(amount)} บาท เดี๋ยวเจ้าหน้าที่ตรวจสอบยอดและประสานรายละเอียดต่อนะคะ 🙏`
      : `รับทราบสลิป เดี๋ยวเจ้าหน้าที่ตรวจสอบยอดและประสานรายละเอียดต่อนะคะ 🙏`;
  }
  ...
  // unclassified
  return `รับทราบสลิป เดี๋ยวเจ้าหน้าที่ตรวจสอบยอดและประสานรายละเอียดต่อนะคะ 🙏`;
}
