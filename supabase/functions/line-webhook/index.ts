...
- 📸 ทุกครั้งที่พูดถึง/แนะนำแพ็กเกจใด ต้องใส่ "แพ็กเกจ: <ชื่อ>" ลงใน image_titles เพื่อส่งรูปพื้นฐานแพ็กเกจให้ลูกค้าเสมอ (ถ้ามีรูป tier เจาะจง ให้ใช้ชื่อ tier เต็มแทน)
