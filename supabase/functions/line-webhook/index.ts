...
${foundOffBkk ? `- ⚠️ ลูกค้าอยู่ "${foundOffBkk}" (นอกเขต กทม+ปริมณฑล) → **ห้ามชวนมาบริษัท ห้ามชวนเดินทางมาชิม** ต้องตอบว่า "ชิมฟรีให้บริการเฉพาะ กทม+ปริมณฑลค่ะ" แล้วเสนอทางเลือก (ส่งเมนู/รูปอาหาร/รีวิวให้ดูแทน) เท่านั้น` : ""}` : "";
